...
import fonts, { adobe, bunny, fontshare, google } from 'vite-plugin-fonts'
...
```ts
import fonts, { createCssApiProvider, defineFont } from 'vite-plugin-fonts'
...
```ts
import type { FontProvider } from 'vite-plugin-fonts'
